...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=63, lastline=74]{PS2_answers_farhan.R}  
	$\chi^2$ is 3.7912
	\item [(b)]
	...
	The p-value is 0.1502 and if $\alpha = .1$ we conclude that the result is not significant. 
	\newpage
...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=86, lastline=89]{PS2_answers_farhan.R}
